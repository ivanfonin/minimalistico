        ...
        <div class="uk-section uk-section-muted uk-section-large">
            <div class="uk-container">
                <div class="uk-flex-middle uk-text-center">
                    ...
                    <p>Оставьте заявку на сайте и мы свяжемся с Вами в течение рабочего дня.</p>
                    <a href="#" class="uk-button uk-button-text">Оставить заявку</a>
                </div>
            </div>
        </div>
                ...
                <div class="uk-margin-top uk-margin-bottom">
                    <div class="uk-child-width-auto@m uk-flex-middle" uk-grid>
                        <div class="uk-width-1-4@m uk-text-left@m uk-text-center uk-text-small" uk-scrollspy="cls:uk-animation-slide-left-small">
                            <p>
                                &copy; 2014-<?php echo date('Y'); ?>, <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">«<?php bloginfo( 'name' ); ?>»</a></p>
                        </div>
